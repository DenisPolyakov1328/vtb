...
const Privelege = () => {
  return (
    <div className="h-full w-full text-white flex flex-col sm:flex-row justify-center sm:justify-start sm:text-start items-center">
      <div className="max-sm:h-1/2 flex sm:block flex-col justify-center items-center text-center sm:text-start sm:w-2/3 relative">
      ...
      <div className="max-sm:h-1/2 sm:w-1/3 flex justify-center sm:block relative">
