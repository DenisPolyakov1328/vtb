    ...
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-[548px]">
      <div className="mb-[50px]">
        <input
          ...
          type="text"
          placeholder="Логин"
          className={`mt-1 placeholder:text-[18px] placeholder:text-descr-blue text-descr-blue block w-full px-[27.5px] py-[23px] border ${errors.username ? 'border-red-error' : 'border-bdr-gray'} rounded-md shadow-sm focus:outline-none`}
          {...register('username', { 
        ...
        />
        {errors.username && <p className="mt-2 text-red-error">{errors.username.message}</p>}
      </div>
      ...
      <div className="mb-[50px] relative">
        <input
          ...
          placeholder="Пароль"
          className={`mt-1 placeholder:text-[18px] placeholder:text-descr-blue text-descr-blue block w-full px-[27.5px] py-[23px] border ${errors.password ? 'border-red-error' : 'border-bdr-gray'} rounded-md shadow-sm focus:outline-none`}
          {...register('password', {
        ...
        {errors.password && <p className="mt-2 text-red-error">{errors.password.message}</p>}
      </div>
      ...
      <div className="mb-3">
        <label className="flex items-baseline text-descr-blue relative">
          <input
            type="checkbox"
            className={(errors?.agreeTerms?.message ? "border-red-error " : "") + "appearance-none absolute top-0.5 left-0 m-0 w-[23px] h-[23px] border rounded-lg bg-gray-200 border-bdr-gray transition-all checked:bg-log-orange checked:border-log-orange " + element.element}
        ...
        {errors.agreeTerms && <p className="mt-2 text-red-error">{errors.agreeTerms.message}</p>}
      </div>
      ...
      <div className="mb-3">
        <label className="flex items-baseline text-descr-blue relative">
          <input
            type="checkbox"
            className={(errors?.receiveUpdates?.message ? "border-red-error " : "") + "appearance-none absolute top-0.5 left-0 m-0 w-[23px] h-[23px] border rounded-lg bg-gray-200 border-bdr-gray transition-all checked:bg-log-orange checked:border-log-orange " + element.element}
        ...
        {errors.receiveUpdates && <p className="mt-2 text-red-error">{errors.receiveUpdates.message}</p>}
      </div>
      ...
      <div className="mb-[50px]">
        <label className="flex items-baseline text-descr-blue relative">
          <input
            type="checkbox"
            className={(errors?.ageConfirmation?.message ? "border-red-error " : "") + "appearance-none absolute top-0.5 left-0 m-0 w-[23px] h-[23px] border rounded-lg bg-gray-200 border-bdr-gray transition-all checked:bg-log-orange checked:border-log-orange " + element.element}
        ...
        {errors.ageConfirmation && <p className="mt-2 text-red-error">{errors.ageConfirmation.message}</p>}
      </div>
